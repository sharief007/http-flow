...
export class HeaderPair implements flatbuffers.IUnpackableObject<HeaderPairT> {
...
unpackTo(_o: HeaderPairT): void {
  _o.key = this.key();
  _o.value = this.value();
}
}

export class HeaderPairT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return HeaderPair.createHeaderPair(builder,
    key,
    value
  );
}
